 ...
 */ const config = {
    ...
    "inlineSchemaHash": "47f06810642ef67c712fba52ec093441ef15f3cf14dce841b6387109cc36b34c",
    "copyEngine": true
};
...
var __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$index$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/prisma/index.ts [app-rsc] (ecmascript) <locals>");
;
async function leadsCampaignFunnel() {
    const campaignId = "lead-whatsapp";
    // 1) messagesSent
    const messagesSent = await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$index$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].promotialMessage.count({
        where: {
            campaignId
        }
    });
    // 2) ordersMade (unique customers with >= 1 order after first message)
    const rows = await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$index$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].$queryRaw`
    ...
    SELECT
      COUNT(DISTINCT fm."customerId")::bigint AS orders_made
    FROM first_message fm
    JOIN "Order" o
      ON o."customerId" = fm."customerId"
     AND o."createdAt" > fm.first_sent_at;
  `;
    const ordersMade = Number(rows[0]?.orders_made ?? 0);
    return {
        messagesSent,
        ordersMade
    };
...
async function Home() {
    ...
    const leadsCampaignFunnelResponse = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$chartData$2f$leadsCampaignFunnel$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["leadsCampaignFunnel"])();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cd40ecc6._.js.map