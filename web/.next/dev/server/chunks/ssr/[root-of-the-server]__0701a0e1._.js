...
"[project]/web/src/generated/prisma/runtime/library.js [app-rsc] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
function fs() {
    return M.default.join(("TURBOPACK compile-time value", "/ROOT/web/src/generated/prisma/runtime"), "../");
}
var ch = "libquery-engine";
M.default.join(("TURBOPACK compile-time value", "/ROOT/web/src/generated/prisma/runtime"), "../query-engine-darwin");
M.default.join(("TURBOPACK compile-time value", "/ROOT/web/src/generated/prisma/runtime"), "../query-engine-darwin-arm64");
M.default.join(("TURBOPACK compile-time value", "/ROOT/web/src/generated/prisma/runtime"), "../query-engine-debian-openssl-1.0.x");
M.default.join(("TURBOPACK compile-time value", "/ROOT/web/src/generated/prisma/runtime"), "../query-engine-debian-openssl-1.1.x");
M.default.join(("TURBOPACK compile-time value", "/ROOT/web/src/generated/prisma/runtime"), "../query-engine-debian-openssl-3.0.x");
M.default.join(("TURBOPACK compile-time value", "/ROOT/web/src/generated/prisma/runtime"), "../query-engine-linux-static-x64");
M.default.join(("TURBOPACK compile-time value", "/ROOT/web/src/generated/prisma/runtime"), "../query-engine-linux-static-arm64");
M.default.join(("TURBOPACK compile-time value", "/ROOT/web/src/generated/prisma/runtime"), "../query-engine-rhel-openssl-1.0.x");
M.default.join(("TURBOPACK compile-time value", "/ROOT/web/src/generated/prisma/runtime"), "../query-engine-rhel-openssl-1.1.x");
M.default.join(("TURBOPACK compile-time value", "/ROOT/web/src/generated/prisma/runtime"), "../query-engine-rhel-openssl-3.0.x");
M.default.join(("TURBOPACK compile-time value", "/ROOT/web/src/generated/prisma/runtime"), "../libquery_engine-darwin.dylib.node");
M.default.join(("TURBOPACK compile-time value", "/ROOT/web/src/generated/prisma/runtime"), "../libquery_engine-darwin-arm64.dylib.node");
M.default.join(("TURBOPACK compile-time value", "/ROOT/web/src/generated/prisma/runtime"), "../libquery_engine-debian-openssl-1.0.x.so.node");
M.default.join(("TURBOPACK compile-time value", "/ROOT/web/src/generated/prisma/runtime"), "../libquery_engine-debian-openssl-1.1.x.so.node");
M.default.join(("TURBOPACK compile-time value", "/ROOT/web/src/generated/prisma/runtime"), "../libquery_engine-debian-openssl-3.0.x.so.node");
M.default.join(("TURBOPACK compile-time value", "/ROOT/web/src/generated/prisma/runtime"), "../libquery_engine-linux-arm64-openssl-1.0.x.so.node");
M.default.join(("TURBOPACK compile-time value", "/ROOT/web/src/generated/prisma/runtime"), "../libquery_engine-linux-arm64-openssl-1.1.x.so.node");
M.default.join(("TURBOPACK compile-time value", "/ROOT/web/src/generated/prisma/runtime"), "../libquery_engine-linux-arm64-openssl-3.0.x.so.node");
M.default.join(("TURBOPACK compile-time value", "/ROOT/web/src/generated/prisma/runtime"), "../libquery_engine-linux-musl.so.node");
M.default.join(("TURBOPACK compile-time value", "/ROOT/web/src/generated/prisma/runtime"), "../libquery_engine-linux-musl-openssl-3.0.x.so.node");
M.default.join(("TURBOPACK compile-time value", "/ROOT/web/src/generated/prisma/runtime"), "../libquery_engine-rhel-openssl-1.0.x.so.node");
M.default.join(("TURBOPACK compile-time value", "/ROOT/web/src/generated/prisma/runtime"), "../libquery_engine-rhel-openssl-1.1.x.so.node");
M.default.join(("TURBOPACK compile-time value", "/ROOT/web/src/generated/prisma/runtime"), "../libquery_engine-rhel-openssl-3.0.x.so.node");
M.default.join(("TURBOPACK compile-time value", "/ROOT/web/src/generated/prisma/runtime"), "../query_engine-windows.dll.node");
...
async function yl(e, r) {
    ...
    let o = await ir(), s = r.generator?.binaryTargets ?? [], a = s.some((d)=>d.native), l = !s.some((d)=>d.value === o), u = ("TURBOPACK compile-time value", "/ROOT/web/src/generated/prisma/runtime/library.js").match(nf()) === null, c = {
        searchedLocations: i,
...
async function of(e, r) {
    let t = await ir(), n = [], i = [
        r.dirname,
        St.default.resolve(("TURBOPACK compile-time value", "/ROOT/web/src/generated/prisma/runtime"), ".."),
        r.generator?.output?.value ?? ("TURBOPACK compile-time value", "/ROOT/web/src/generated/prisma/runtime"),
        St.default.resolve(("TURBOPACK compile-time value", "/ROOT/web/src/generated/prisma/runtime"), "../../../.prisma/client"),
        "/tmp/prisma-engines",
        r.cwd
    ];
    ("TURBOPACK compile-time value", "/ROOT/web/src/generated/prisma/runtime/library.js").includes("resolveEnginePath") && i.push(fs());
    for (let o of i){
...
const { PrismaClientKnownRequestError, PrismaClientUnknownRequestError, PrismaClientRustPanicError, PrismaClientInitializationError, PrismaClientValidationError, getPrismaClient, sqltag, empty, join, raw, skip, Decimal, Debug, objectEnumValues, makeStrictEnum, Extensions, warnOnce, defineDmmfProperty, Public, getRuntime, createParam } = __turbopack_context__.r("[project]/web/src/generated/prisma/runtime/library.js [app-rsc] (ecmascript)");
const Prisma = {};
...
config.dirname = ("TURBOPACK compile-time value", "/ROOT/web/src/generated/prisma");
if (!fs.existsSync(path.join(("TURBOPACK compile-time value", "/ROOT/web/src/generated/prisma"), 'schema.prisma'))) {
...
const { warnEnvConflicts } = __turbopack_context__.r("[project]/web/src/generated/prisma/runtime/library.js [app-rsc] (ecmascript)");
warnEnvConflicts({
...
path.join(("TURBOPACK compile-time value", "/ROOT/web/src/generated/prisma"), "libquery_engine-darwin-arm64.dylib.node");
path.join(process.cwd(), "src/generated/prisma/libquery_engine-darwin-arm64.dylib.node");
// file annotations for bundling tools to include these files
path.join(("TURBOPACK compile-time value", "/ROOT/web/src/generated/prisma"), "schema.prisma");
path.join(process.cwd(), "src/generated/prisma/schema.prisma");
}),
"[project]/web/prisma/index.ts [app-rsc] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$prisma$2f$index$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/web/prisma/index.ts [app-rsc] (ecmascript) <locals>");
;
const getProducts = async ()=>{
    const prismaCategories = await __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$prisma$2f$index$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].category.findMany({
        select: {
            id: true,
            name: true,
            products: {
    ...
    const prismaProgressiveDiscount = await __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$prisma$2f$index$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].progressiveDiscount.findUnique({
        where: {
...
const findProductById = (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$server$2d$dom$2d$turbopack$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerClientReference"])(function() {
...
;
const Menu = async ()=>{
    const categories = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$src$2f$getProducts$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"])();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0701a0e1._.js.map