...
import type { GetOrderQuantityAnalyticsUseCase } from "../../application/use-cases/GetOrderQuantityAnalyticsUseCase.js";

export class GetOrderQuantityAnalyticsController implements HttpController {
  constructor(private readonly useCase: GetOrderQuantityAnalyticsUseCase) {}
