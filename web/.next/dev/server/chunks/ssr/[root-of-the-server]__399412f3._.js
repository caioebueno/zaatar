...
const getCustomerData = async (data)=>{
    const findCustomer = await __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$prisma$2f$index$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].customer.findFirst({
        where: {
            phone: data.phone
        },
        include: {
    ...
    if (!findCustomer) {
        const createdCustomer = await __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$prisma$2f$index$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].customer.create({
            data: {
...
const addNewDeliveryAddress = async (data)=>{
    const createdAddress = await __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$prisma$2f$index$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].deliveryAddress.create({
        data: {
...
const updateCustomerName = async (data)=>{
    const customer = await __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$prisma$2f$index$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].customer.update({
        where: {
            id: data.customerId
        },
        data: {
...
var __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/crypto [external] (crypto, cjs)");
(()=>{
    const e = new Error("Cannot find module '../web/utils/calculateProductPriceWithProgressiveDiscount'");
...
const createOrder = async (data)=>{
    ...
    const createdOrder = await __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$prisma$2f$index$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].order.create({
        data: {
            id: (0, __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["randomUUID"])(),
            amount: 0,
            ...
            orderProducts: {
                createMany: {
                    data: data.cart.items.map((item)=>{
                        const price = calculateProductPriceWithProgressiveDiscount(item.productId, progressiveDiscount, data.cart, productData.categories);
                        if (!price) throw {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__399412f3._.js.map