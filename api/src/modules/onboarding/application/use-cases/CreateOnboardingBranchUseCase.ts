...
export type CreateOnboardingBranchInput = {
...
export type CreateOnboardingBranchOutput = {
...
export class CreateOnboardingBranchUseCase {
  constructor(private readonly repository: BusinessOnboardingRepository) {}

  async execute(input: CreateOnboardingBranchInput): Promise<CreateOnboardingBranchOutput> {
