...
import type { GetNewCustomersAnalyticsUseCase } from "../../application/use-cases/GetNewCustomersAnalyticsUseCase.js";

export class GetNewCustomersAnalyticsController implements HttpController {
  constructor(private readonly useCase: GetNewCustomersAnalyticsUseCase) {}
