...
"[project]/src/getCustomerData.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const getCustomerData = async (data)=>{
    const findCustomer = await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].customer.findFirst({
        where: {
            phone: data.phone
        }
    });
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$getCustomerData$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/getCustomerData.ts [app-ssr] (ecmascript)");
"use client";
;
;
;
...
const AddressStep = ({ onBack })=>{
    const handleConfirm = async ()=>{
        const customer = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$getCustomerData$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])({
            phone: '19297669288'
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e74d5a8e._.js.map