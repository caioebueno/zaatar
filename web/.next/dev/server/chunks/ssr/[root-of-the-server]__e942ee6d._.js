...
const clientOrderCount = async ()=>{
    ...
    for (const customer of customers){
        ...
        counts[orderCount] = (counts[orderCount] || 0) + 1;
    }
    return Object.entries(counts).sort((a, b)=>Number(a[0]) - Number(b[0])) // sort ascending
    .map(([orders, clients])=>({
            orders,
            clients
        }));
...
async function Home() {
    ...
    console.log(clientOrderCountResponse);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e942ee6d._.js.map