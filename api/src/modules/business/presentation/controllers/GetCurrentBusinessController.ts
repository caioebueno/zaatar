...
import type { GetCurrentBusinessUseCase } from "../../application/use-cases/GetCurrentBusinessUseCase.js";

export class GetCurrentBusinessController implements HttpController {
  constructor(private readonly useCase: GetCurrentBusinessUseCase) {}
