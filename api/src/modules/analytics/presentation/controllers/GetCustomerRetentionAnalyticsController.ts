...
import type { GetCustomerRetentionAnalyticsUseCase } from "../../application/use-cases/GetCustomerRetentionAnalyticsUseCase.js";

export class GetCustomerRetentionAnalyticsController implements HttpController {
  constructor(private readonly useCase: GetCustomerRetentionAnalyticsUseCase) {}
