...
export default async function Home() {
  ...
  const leadsCampaignFunnelResponse = await leadsCampaignFunnel('lead-whatsapp')
      ...
      <div className='grid grid-cols-[350px_auto]'>
        <div>
          <h2 className="text-lg font-semibold mb-3">
           ...
           <p className='mb-2'>Disparo de mensagens via Whatsapp para leads que nunca efetuaram nenhum pedido</p>
          <p><b>Data de início: </b>{format(
