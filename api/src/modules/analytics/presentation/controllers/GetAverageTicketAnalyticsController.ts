...
import type { GetAverageTicketAnalyticsUseCase } from "../../application/use-cases/GetAverageTicketAnalyticsUseCase.js";

export class GetAverageTicketAnalyticsController implements HttpController {
  constructor(private readonly useCase: GetAverageTicketAnalyticsUseCase) {}
