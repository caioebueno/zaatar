  ...
  return (
    <div className="p-4 bg-foreground fixed bottom-0 w-full flex flex-col box-shadow">
      <div className="flex flex-row justify-between">
        ...
        <span className="text- font-semibold underline text-sm text-lightText">Learn more</span>
      </div>
      ...
      <div className="flex flex-row items-center justify-between">
        <div className={`flex flex-row items-center gap-2.5 ${animate ? "flex animate-bounce" : "flex"}`}>
